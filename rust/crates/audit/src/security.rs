...
impl TieredRateLimiter {
    ...
    pub fn classify(path: &str) -> RateTier {
        match path {
            ...
            "/api/models/pull" | "/api/runs/parallel" | "/api/swarm/start" => RateTier::Heavy,
...
mod tests {
    ...
    fn tier_classify_stream_endpoints() {
        assert_eq!(
            TieredRateLimiter::classify("/api/complete/stream"),
            RateTier::Stream
        );
        assert_eq!(
            TieredRateLimiter::classify("/api/chat/stream"),
            RateTier::Stream
        );
        assert_eq!(
            TieredRateLimiter::classify("/api/complete"),
            RateTier::Stream
        );
    }
    ...
    fn tier_classify_heavy_endpoints() {
        assert_eq!(
            TieredRateLimiter::classify("/api/runs/parallel"),
            RateTier::Heavy
        );
        assert_eq!(
            TieredRateLimiter::classify("/api/models/pull"),
            RateTier::Heavy
        );
    ...
    fn tier_classify_exempt_endpoints() {
        ...
        assert_eq!(
            TieredRateLimiter::classify("/api/inference/stats"),
            RateTier::Exempt
        );
    }
    ...
    fn tier_classify_standard_endpoints() {
        assert_eq!(
            TieredRateLimiter::classify("/api/audit"),
            RateTier::Standard
        );
        assert_eq!(
            TieredRateLimiter::classify("/api/templates"),
            RateTier::Standard
        );
    }
